...
spa.shell = (function(){
	...
	var
		...
		stateMap = {
			$container: null,
			//マップの現在のアンカー値をモジュール状態stateMap.anchor_mapに格納
			anchor_map: {},
	...
	//目的：チャットスライダーの拡大や格納を行う
	//引数：
	// do_extend - trueの場合スライダーを拡大、falseの場合スライダーを格納
  ...
  // 提示された状態が金損の状態と異なる場合のみ、アプリケーションを調整
  //
